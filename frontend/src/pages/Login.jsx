...
export default function Login() {
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#13111a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ maxWidth: 400, width: '100%', padding: 36, borderRadius: 22, background: '#232136', boxShadow: '0 8px 32px 0 #7c3aed22', border: '2px solid #232136', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 24 }}>
                    ...
                    <h2 style={{ margin: 0, fontWeight: 800, fontSize: 28, color: '#fff', letterSpacing: '-0.5px' }}>Sign in to Gam3ly</h2>
                </div>
                <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 18, width: '100%' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                        ...
                        <input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} className="input" style={{ padding: 12, borderRadius: 8, border: '1.5px solid #a78bfa', fontSize: 16, color: '#fff', background: '#181622' }} autoFocus />
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                    ...
                    <button type="submit" className="btn accent" style={{ marginTop: 8, fontWeight: 700, fontSize: 17, background: 'linear-gradient(90deg, #a78bfa 60%, #7c3aed 100%)', color: '#fff', borderRadius: 10, boxShadow: '0 2px 8px #7c3aed22', border: 'none', padding: '12px 0' }}>Sign In</button>
                </form>
                <div style={{ marginTop: 18, textAlign: 'center', fontSize: 15 }}>
                    <span style={{ color: '#b3b3c6' }}>Don't have an account? </span>
                    <span style={{ color: '#a78bfa', cursor: 'pointer', fontWeight: 700 }} onClick={() => navigate('/signup')}>Sign up</span>
                </div>
            </div>
        </div>
    )
